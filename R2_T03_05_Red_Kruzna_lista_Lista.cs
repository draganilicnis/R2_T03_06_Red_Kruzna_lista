    ...
    static void Main()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (c == 'u')                               // Dodavanje novog igraca u kolo koji odmah postaje vodja
            {
                ...
                a.Insert(v, b);                         // Nov igrac/vodja se dodaje u kolo ispred onog koji ima sesir (na poziciji b)
            }
